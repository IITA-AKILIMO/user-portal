...
class ExtendedValue extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(ExtendedValue::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_ExtendedValue');
