...
class WaterfallChartCustomSubtotal extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(WaterfallChartCustomSubtotal::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_WaterfallChartCustomSubtotal');
