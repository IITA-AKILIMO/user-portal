...
class MatchedValueRange extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(MatchedValueRange::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_MatchedValueRange');
