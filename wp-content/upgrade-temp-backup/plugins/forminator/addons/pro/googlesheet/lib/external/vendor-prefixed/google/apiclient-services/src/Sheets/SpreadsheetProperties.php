...
class SpreadsheetProperties extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SpreadsheetProperties::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_SpreadsheetProperties');
