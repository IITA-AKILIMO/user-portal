...
class SpreadsheetTheme extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(SpreadsheetTheme::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_SpreadsheetTheme');
