...
class BasicChartAxis extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(BasicChartAxis::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_BasicChartAxis');
