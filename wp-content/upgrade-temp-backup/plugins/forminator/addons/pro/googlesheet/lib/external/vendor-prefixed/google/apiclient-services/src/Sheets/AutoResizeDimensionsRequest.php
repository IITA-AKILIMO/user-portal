...
class AutoResizeDimensionsRequest extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(AutoResizeDimensionsRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_AutoResizeDimensionsRequest');
