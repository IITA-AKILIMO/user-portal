...
class CandlestickData extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(CandlestickData::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_CandlestickData');
