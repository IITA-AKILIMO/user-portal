...
class RefreshDataSourceObjectExecutionStatus extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(RefreshDataSourceObjectExecutionStatus::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_RefreshDataSourceObjectExecutionStatus');
