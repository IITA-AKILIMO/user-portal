...
class Search extends \ET_Builder_Module {
	...
	public function init() {
		$this->name = esc_html__( 'Google Drive Search Box', 'integrate-google-drive' );
	...
	public function get_fields() {
		return array(
			'data' => array(
				...
				'default'         => '{"isInit":true,"status":"on","type":"search","folders":[],"showFiles":true,"showFolders":true,"moduleWidth": "100%", "moduleHeight": "auto","fileNumbers":1000,"sort":{"sortBy":"name","sortDirection":"asc"},"view":"list","maxFileSize":"","preview":"true","download":true,"displayFor":"everyone","displayUsers":["everyone"],"displayExcept":[]}',
