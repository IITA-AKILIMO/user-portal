 ...
 * with the `IGDGoogle_Logger_Psr::setLogger()` method.
 */
class IGDGoogle_Logger_Psr extends IGDGoogle_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(IGDGoogle_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
