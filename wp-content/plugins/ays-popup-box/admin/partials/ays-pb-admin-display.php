    ...
    <?php if($popup_max_id <= 1): ?>
            <div class="ays-pb-create-pb-video-box" style="">
                <div class="ays-pb-create-pb-title">
                    <h4><?php echo __( "Create Your First Popup in Under One Minute", $this->plugin_name ); ?></h4>
                </div>
                ...
                <div class="ays-pb-create-pb-youtube-video-button-box">
                    ...
                    <?php echo sprintf(  '<a href="?page=%s&action=%s" class="page-title-action ays-pb-add-new-button-video">'. __( "Add New" ) .'</a>', esc_attr( $_REQUEST['page'] ), 'add');?>
                </div>
            </div>
        <?php else: ?>
