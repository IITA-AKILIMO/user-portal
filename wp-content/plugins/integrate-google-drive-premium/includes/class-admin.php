...
class Admin {
	...
	public function admin_menu() {
		...
		if ( $can_access_file_browser ) {
			$this->pages['file_browser_page'] = add_menu_page( __( 'Integrate Google Drive', 'integrate-google-drive' ), __( 'Google Drive', 'integrate-google-drive' ), 'read',
				'integrate-google-drive', [ 'IGD\App', 'view' ], IGD_ASSETS . '/images/drive.png', 30
			);
			$this->pages['file_browser_page'] = add_submenu_page( 'integrate-google-drive', __( 'File Browser - Integrate Google Drive', 'integrate-google-drive' ), __( 'File Browser', 'integrate-google-drive' ), 'read', 'integrate-google-drive' );
		...
		if ( $can_access_shortcode_builder ) {
			if ( ! $main_menu_added ) {
				$this->pages['shortcode_builder_page'] = add_menu_page( __( 'Integrate Google Drive', 'integrate-google-drive' ), __( 'Google Drive', 'integrate-google-drive' ), 'read',
					'integrate-google-drive', [
						'IGD\Shortcode_Builder',
						'view'
					], IGD_ASSETS . '/images/drive.png', 30
				);
				$this->pages['shortcode_builder_page'] = add_submenu_page( 'integrate-google-drive', __( 'Shortcode Builder - Integrate Google Drive', 'integrate-google-drive' ), __( 'Shortcode Builder', 'integrate-google-drive' ), 'read', 'integrate-google-drive', [
					'IGD\Shortcode_Builder',
					'view'
				] );
				...
				$this->pages['shortcode_builder_page'] = add_submenu_page( 'integrate-google-drive', __( 'Shortcode Builder - Integrate Google Drive', 'integrate-google-drive' ), __( 'Shortcode Builder', 'integrate-google-drive' ), 'read', 'integrate-google-drive-shortcode-builder', [
					'IGD\Shortcode_Builder',
					'view'
				], 90 );
			}
		...
		if ( $can_access_private_files ) {
			if ( ! $main_menu_added ) {
				$this->pages['private_files_page'] = add_menu_page( __( 'Integrate Google Drive', 'integrate-google-drive' ), __( 'Google Drive', 'integrate-google-drive' ), 'read',
					'integrate-google-drive', [ 'IGD\App', 'view' ], IGD_ASSETS . '/images/drive.png', 30
				);
				$this->pages['private_files_page'] = add_submenu_page( 'integrate-google-drive', __( 'Users Private Files - Integrate Google Drive', 'integrate-google-drive' ), __( 'Users Private Files', 'integrate-google-drive' ), 'read', 'integrate-google-drive', [
					'IGD\Private_Folders',
					'view'
				] );
				...
				$this->pages['private_files_page'] = add_submenu_page( 'integrate-google-drive', __( 'Users Private Files - Integrate Google Drive', 'integrate-google-drive' ), __( 'Users Private Files', 'integrate-google-drive' ), 'read', 'integrate-google-drive-private-files', [
					'IGD\Private_Folders',
					'view'
				], 90 );
			}
		...
		if ( $can_access_getting_started ) {
			if ( ! $main_menu_added ) {
				$this->pages['getting_started_page'] = add_menu_page( __( 'Integrate Google Drive', 'integrate-google-drive' ), __( 'Google Drive', 'integrate-google-drive' ), 'read',
					'integrate-google-drive', [ 'IGD\App', 'view' ], IGD_ASSETS . '/images/drive.png', 30
				);
				$this->pages['getting_started_page'] = add_submenu_page( 'integrate-google-drive', __( 'Getting Started - Integrate Google Drive', 'integrate-google-drive' ), __( 'Getting Started', 'integrate-google-drive' ), 'read', 'integrate-google-drive', [
					$this,
				...
				$this->pages['getting_started_page'] = add_submenu_page( 'integrate-google-drive', __( 'Getting Started - Integrate Google Drive', 'integrate-google-drive' ), __( 'Getting Started', 'integrate-google-drive' ), 'read', 'integrate-google-drive-getting-started', [
					$this,
					'render_getting_started_page'
				], 90 );
			}
		...
		if ( igd_fs()->can_use_premium_code__premium_only() ) {
			$can_access_statistics = ! empty( array_intersect( $current_user->roles, $statistics_user_roles ) ) || in_array( $current_user->ID, $statistics_users ) || ( is_multisite() && is_super_admin() );

			if ( $can_access_statistics && igd_get_settings( 'enableStatistics', false ) ) {
				if ( ! $main_menu_added ) {
					$this->pages['statistics_page'] = add_menu_page( __( 'Integrate Google Drive', 'integrate-google-drive' ), __( 'Google Drive', 'integrate-google-drive' ), 'read',
						'integrate-google-drive', [
							'IGD\Statistics',
							'view'
						], IGD_ASSETS . '/images/drive.png', 30
					);
					$this->pages['statistics_page'] = add_submenu_page( 'integrate-google-drive', __( 'Statistics - Integrate Google Drive', 'integrate-google-drive' ), __( 'Statistics', 'integrate-google-drive' ), 'read', 'integrate-google-drive', [
						'IGD\Statistics',
						'view'
					] );
					$main_menu_added                = true;
				} else {
					$this->pages['statistics_page'] = add_submenu_page( 'integrate-google-drive', __( 'Statistics - Integrate Google Drive', 'integrate-google-drive' ), __( 'Statistics', 'integrate-google-drive' ), 'read', 'integrate-google-drive-statistics', [
						'IGD\Statistics',
						'view'
					], 90 );
				}
		...
		if ( $can_access_settings ) {
			if ( ! $main_menu_added ) {
				$this->pages['settings_page'] = add_menu_page( __( 'Integrate Google Drive', 'integrate-google-drive' ), __( 'Google Drive', 'integrate-google-drive' ), 'read',
					'integrate-google-drive', [ $this, 'render_settings_page' ], IGD_ASSETS . '/images/drive.png', 30
				);
				$this->pages['settings_page'] = add_submenu_page( 'integrate-google-drive', __( 'Settings - Integrate Google Drive', 'integrate-google-drive' ), __( 'Settings', 'integrate-google-drive' ), 'read', 'integrate-google-drive', [
					$this,
				...
				$this->pages['settings_page'] = add_submenu_page( 'integrate-google-drive', __( 'Settings - Integrate Google Drive', 'integrate-google-drive' ),
					__( 'Settings', 'integrate-google-drive' ), 'read', 'integrate-google-drive-settings', [
						$this,
						'render_settings_page'
					], 90
				);
