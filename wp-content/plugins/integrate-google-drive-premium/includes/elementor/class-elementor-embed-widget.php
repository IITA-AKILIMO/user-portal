...
class Embed_Widget extends Widget_Base {
	...
	public function get_title() {
		return __( 'Embed Documents', 'integrate-google-drive' );
	}
	...
	public function register_controls() {
		...
		$this->start_controls_section( '_section_module_builder',
			[
				'label' => __( 'Embed Documents', 'integrate-google-drive' ),
	...
	public function render() {
		...
		if ( $is_init && Plugin::$instance->editor->is_edit_mode() ) { ?>
            <div class="module-builder-placeholder">
                ...
                <img src="<?php echo IGD_ASSETS . '/images/shortcode-builder/types/embed.svg' ?>">
                <h3><?php _e( 'Embed Documents', 'integrate-google-drive' ); ?></h3>
