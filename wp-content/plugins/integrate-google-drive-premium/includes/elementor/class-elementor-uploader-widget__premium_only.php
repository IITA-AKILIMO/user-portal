...
class Uploader_Widget extends Widget_Base {
	...
	public function get_title() {
		return __( 'File Uploader', 'integrate-google-drive' );
	}
	...
	public function register_controls() {
		...
		$this->start_controls_section( '_section_module_builder',
			[
				'label' => __( 'File Uploader', 'integrate-google-drive' ),
	...
	public function render() {
		...
		if ( $is_init && Plugin::$instance->editor->is_edit_mode() ) { ?>
            <div class="module-builder-placeholder">
                ...
                <img src="<?php echo IGD_ASSETS . '/images/shortcode-builder/types/uploader.svg' ?>">
                <h3><?php _e( 'File Uploader', 'integrate-google-drive' ); ?></h3>
