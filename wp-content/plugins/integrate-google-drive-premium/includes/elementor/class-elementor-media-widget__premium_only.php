...
class Media_Widget extends Widget_Base {
	...
	public function get_title() {
		return __( 'Media Player', 'integrate-google-drive' );
	}
	...
	public function register_controls() {
		...
		$this->start_controls_section( '_section_module_builder',
			[
				'label' => __( 'Media Player', 'integrate-google-drive' ),
		...
		$this->add_control( 'module_data', [
			...
			'render_type' => 'none',
			'default'     => '{"isInit":true,"status":"on","type":"media","folders":[],"showFiles":true,"showFolders":true,"moduleWidth": "100%", "moduleHeight": "auto","fileNumbers":1000,"sort":{"sortBy":"name","sortDirection":"asc"},"view":"list","maxFileSize":"","preview":"true","download":true,"displayFor":"everyone","displayUsers":["everyone"],"displayExcept":[]}',
		] );
	...
	public function render() {
		...
		if ( $is_init && Plugin::$instance->editor->is_edit_mode() ) { ?>
            <div class="module-builder-placeholder">
                ...
                <img src="<?php echo IGD_ASSETS . '/images/shortcode-builder/types/media.svg' ?>">
                <h3><?php _e( 'Media Player', 'integrate-google-drive' ); ?></h3>
