...
class Hooks {
	...
	public function __construct() {
		...
		if ( igd_fs()->can_use_premium_code__premium_only() ) {
			...
			add_filter( 'igd_render_form_field_data', [ $this, 'render_form_field_data__premium_only' ], 10, 2 );
	...
	public function render_form_field_data__premium_only( $data, $as_html ) {
		...
		foreach ( $uploaded_files as $file ) { ?>
            <div style="display: block; margin-bottom: 10px; padding: 10px; border: 1px solid #ddd;background-color: #FAFAFA;">
