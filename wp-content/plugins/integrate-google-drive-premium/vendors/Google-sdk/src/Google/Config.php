...
class IGDGoogle_Config
{
    ...
    /**
     * Create a new IGDGoogle_Config. Can accept an ini file location with the
    ...
    public function __construct($ini_file_location = null)
    {
        $this->configuration = [
            ...
            'application_name' => 'Google Drive to WP - '.IGD_VERSION,

            // Which Authentication, Storage and HTTP IO classes to use.
            'auth_class' => 'IGDGoogle_Auth_OAuth2',
            'io_class' => self::USE_AUTO_IO_SELECTION,
            'cache_class' => 'IGDGoogle_Cache_File',
            'logger_class' => 'IGDGoogle_Logger_Null',
            ...
            'classes' => [
                ...
                'IGDGoogle_Logger_Abstract' => [
                    'level' => 'debug',
                    'log_format' => "[%datetime%] %level%: %message% %context%\n",
                    'date_format' => 'd/M/Y:H:i:s O',
                    'allow_newlines' => true,
                ],
                'IGDGoogle_Logger_File' => [
                    'file' => 'php://stdout',
                    'mode' => 0640,
                    'lock' => false,
                ],
                'IGDGoogle_Http_Request' => [
                ...
                'IGDGoogle_Cache_File' => [
                    'directory' => sys_get_temp_dir().'/IGDGoogle_Client',
                ],
            ],
        ];
     ...
     * the hd values within an id token (@see IGDGoogle_Auth_LoginTicket) after sign
