...
/**
 * Http Streams based implementation of IGDGoogle_IO.
 *
...
class IGDGoogle_IO_Stream extends IGDGoogle_IO_Abstract
{
  ...
  public function executeRequest(IGDGoogle_Http_Request $request)
  {
    ...
    if ($this->trappedErrorNumber) {
      ...
      throw new IGDGoogle_IO_Exception($error, $this->trappedErrorNumber);
    }
    ...
    if (false === $response_data) {
      ...
      $this->client->getLogger()->error('Stream ' . $error);
      throw new IGDGoogle_IO_Exception($error, $respHttpCode);
    }
