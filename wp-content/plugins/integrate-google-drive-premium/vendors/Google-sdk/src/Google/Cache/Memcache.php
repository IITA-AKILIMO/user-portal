 ...
 */
class IGDGoogle_Cache_Memcache extends IGDGoogle_Cache_Abstract
{
  ...
  public function __construct(IGDGoogle_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new IGDGoogle_Cache_Exception($error);
    }
   ...
   * @param string $key
   * @param string $value
   * @throws IGDGoogle_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new IGDGoogle_Cache_Exception("Couldn't store data in cache");
    }
