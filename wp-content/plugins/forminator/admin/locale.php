...
"Width" => array( null, __("Width", "forminator" ), ), // src/form/components/fields/paypal.js:298
...
"Height" => array( null, __("Height", "forminator" ), ), // src/form/components/fields/paypal.js:336
...
"{{strong}}Note:{{/strong}} The query parameter's value passed in URL should match with the selected time format." => array( null, __("{{strong}}Note:{{/strong}} The query parameter's value passed in URL should match with the selected time format.", "forminator" ), ), // src/form/components/fields/time.js:191
"Number inputs" => array( null, __("Number inputs", "forminator" ), ), // src/form/components/fields/time.js:229
"Format" => array( null, __("Format", "forminator" ), ), // src/form/components/fields/time.js:237
"12 hour" => array( null, __("12 hour", "forminator" ), ), // src/form/components/fields/time.js:240
"24 hour" => array( null, __("24 hour", "forminator" ), ), // src/form/components/fields/time.js:241
"We have mapped the time limit you have set to match the new time format you have chosen. falseYou can adjust this limit under the Settings tab." => array( null, __("We have mapped the time limit you have set to match the new time format you have chosen. falseYou can adjust this limit under the Settings tab.", "forminator" ), ), // src/form/components/fields/time.js:264
"Hours" => array( null, __("Hours", "forminator" ), ), // src/form/components/fields/time.js:302
"Minutes" => array( null, __("Minutes", "forminator" ), ), // src/form/components/fields/time.js:328
"Increments" => array( null, __("Increments", "forminator" ), ), // src/form/components/fields/time.js:364
"Choose what time increments you want to use for the hour and minute timepickers." => array( null, __("Choose what time increments you want to use for the hour and minute timepickers.", "forminator" ), ), // src/form/components/fields/time.js:366
"Hour" => array( null, __("Hour", "forminator" ), ), // src/form/components/fields/time.js:377
"Minute" => array( null, __("Minute", "forminator" ), ), // src/form/components/fields/time.js:389
"Choose a time limit for the time picker field to restrict the time selection between specific hours." => array( null, __("Choose a time limit for the time picker field to restrict the time selection between specific hours.", "forminator" ), ), // src/form/components/fields/time.js:403
"Specific Hours" => array( null, __("Specific Hours", "forminator" ), ), // src/form/components/fields/time.js:422
"Start Time" => array( null, __("Start Time", "forminator" ), ), // src/form/components/fields/time.js:425
"AM" => array( null, __("AM", "forminator" ), ), // src/form/components/fields/time.js:460
"PM" => array( null, __("PM", "forminator" ), ), // src/form/components/fields/time.js:461
"End Time" => array( null, __("End Time", "forminator" ), ), // src/form/components/fields/time.js:467
"This error message will be used when time entered is out of the set limits." => array( null, __("This error message will be used when time entered is out of the set limits.", "forminator" ), ), // src/form/components/fields/time.js:516
"Default Time" => array( null, __("Default Time", "forminator" ), ), // src/form/components/fields/time.js:530
"Use this feature to specify a default selected time." => array( null, __("Use this feature to specify a default selected time.", "forminator" ), ), // src/form/components/fields/time.js:532
"Default time can't be outside the allowed time limit." => array( null, __("Default time can't be outside the allowed time limit.", "forminator" ), ), // src/form/components/fields/time.js:597
...
"Email Routing" => array( null, __("Email Routing", "forminator" ), ), // src/form/components/modals/notification.js:538
"Enter from name here" => array( null, __("Enter from name here", "forminator" ), ), // src/form/components/modals/notification.js:565
"From Name" => array( null, __("From Name", "forminator" ), ), // src/form/components/modals/notification.js:566
"Enter from email here" => array( null, __("Enter from email here", "forminator" ), ), // src/form/components/modals/notification.js:586
"From Email" => array( null, __("From Email", "forminator" ), ), // src/form/components/modals/notification.js:587
"Some hosts do not allow \"from email\" to be overridden or replaced due to spam issues." => array( null, __("Some hosts do not allow \"from email\" to be overridden or replaced due to spam issues.", "forminator" ), ), // src/form/components/modals/notification.js:618
"Enter reply-to email here" => array( null, __("Enter reply-to email here", "forminator" ), ), // src/form/components/modals/notification.js:636
"Reply-to Email" => array( null, __("Reply-to Email", "forminator" ), ), // src/form/components/modals/notification.js:637
"Enter CC email here" => array( null, __("Enter CC email here", "forminator" ), ), // src/form/components/modals/notification.js:658
"CC Emails" => array( null, __("CC Emails", "forminator" ), ), // src/form/components/modals/notification.js:659
"Enter BCC email here" => array( null, __("Enter BCC email here", "forminator" ), ), // src/form/components/modals/notification.js:680
"BCC Emails" => array( null, __("BCC Emails", "forminator" ), ), // src/form/components/modals/notification.js:681
"Discard Changes" => array( null, __("Discard Changes", "forminator" ), ), // src/form/components/modals/notification.js:725
...
"Submissions limit per logged in user" => array( null, __("Submissions limit per logged in user", "forminator" ), ), // src/global/components/behaviour/security.js:128
"Enter the number of times a logged in user can submit this form. Leave blank or enter “0” for no limit." => array( null, __("Enter the number of times a logged in user can submit this form. Leave blank or enter “0” for no limit.", "forminator" ), ), // src/global/components/behaviour/security.js:129
"Message when user has already reached submissions limit" => array( null, __("Message when user has already reached submissions limit", "forminator" ), ), // src/global/components/behaviour/security.js:138
"You’ve already reached submissions limit." => array( null, __("You’ve already reached submissions limit.", "forminator" ), ), // src/global/components/behaviour/security.js:139
...
"Coma" => array( null, __("Coma", "forminator" ), ), // src/settings/inputs/calculation.js:399
...
"No available options" => array( null, __("No available options", "forminator" ), ), // src/settings/inputs/sui-variables.js:141
