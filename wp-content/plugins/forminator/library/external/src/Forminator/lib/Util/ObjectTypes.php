...
class ObjectTypes
{
    ...
    const mapping = [
        ...
        \Forminator\Stripe\BalanceSettings::OBJECT_NAME => \Forminator\Stripe\BalanceSettings::class,
        ...
        \Forminator\Stripe\Billing\Alert::OBJECT_NAME => \Forminator\Stripe\Billing\Alert::class,
        \Forminator\Stripe\Billing\AlertTriggered::OBJECT_NAME => \Forminator\Stripe\Billing\AlertTriggered::class,
        \Forminator\Stripe\Billing\CreditBalanceSummary::OBJECT_NAME => \Forminator\Stripe\Billing\CreditBalanceSummary::class,
        \Forminator\Stripe\Billing\CreditBalanceTransaction::OBJECT_NAME => \Forminator\Stripe\Billing\CreditBalanceTransaction::class,
        \Forminator\Stripe\Billing\CreditGrant::OBJECT_NAME => \Forminator\Stripe\Billing\CreditGrant::class,
        ...
        \Forminator\Stripe\InvoicePayment::OBJECT_NAME => \Forminator\Stripe\InvoicePayment::class,
        \Forminator\Stripe\InvoiceRenderingTemplate::OBJECT_NAME => \Forminator\Stripe\InvoiceRenderingTemplate::class,
        ...
        \Forminator\Stripe\PaymentAttemptRecord::OBJECT_NAME => \Forminator\Stripe\PaymentAttemptRecord::class,
        \Forminator\Stripe\PaymentIntent::OBJECT_NAME => \Forminator\Stripe\PaymentIntent::class,
        \Forminator\Stripe\PaymentIntentAmountDetailsLineItem::OBJECT_NAME => \Forminator\Stripe\PaymentIntentAmountDetailsLineItem::class,
        ...
        \Forminator\Stripe\PaymentRecord::OBJECT_NAME => \Forminator\Stripe\PaymentRecord::class,
        ...
        \Forminator\Stripe\Radar\PaymentEvaluation::OBJECT_NAME => \Forminator\Stripe\Radar\PaymentEvaluation::class,
        ...
        \Forminator\Stripe\Reserve\Hold::OBJECT_NAME => \Forminator\Stripe\Reserve\Hold::class,
        \Forminator\Stripe\Reserve\Plan::OBJECT_NAME => \Forminator\Stripe\Reserve\Plan::class,
        \Forminator\Stripe\Reserve\Release::OBJECT_NAME => \Forminator\Stripe\Reserve\Release::class,
        ...
        \Forminator\Stripe\Tax\Association::OBJECT_NAME => \Forminator\Stripe\Tax\Association::class,
        ...
        \Forminator\Stripe\Terminal\OnboardingLink::OBJECT_NAME => \Forminator\Stripe\Terminal\OnboardingLink::class,
    ...
    const v2Mapping = [
        ...
        \Forminator\Stripe\V2\Billing\MeterEvent::OBJECT_NAME => \Forminator\Stripe\V2\Billing\MeterEvent::class,
        \Forminator\Stripe\V2\Billing\MeterEventAdjustment::OBJECT_NAME => \Forminator\Stripe\V2\Billing\MeterEventAdjustment::class,
        \Forminator\Stripe\V2\Billing\MeterEventSession::OBJECT_NAME => \Forminator\Stripe\V2\Billing\MeterEventSession::class,
        \Forminator\Stripe\V2\Core\Account::OBJECT_NAME => \Forminator\Stripe\V2\Core\Account::class,
        \Forminator\Stripe\V2\Core\AccountLink::OBJECT_NAME => \Forminator\Stripe\V2\Core\AccountLink::class,
        \Forminator\Stripe\V2\Core\AccountPerson::OBJECT_NAME => \Forminator\Stripe\V2\Core\AccountPerson::class,
        \Forminator\Stripe\V2\Core\AccountPersonToken::OBJECT_NAME => \Forminator\Stripe\V2\Core\AccountPersonToken::class,
        \Forminator\Stripe\V2\Core\AccountToken::OBJECT_NAME => \Forminator\Stripe\V2\Core\AccountToken::class,
        \Forminator\Stripe\V2\Core\Event::OBJECT_NAME => \Forminator\Stripe\V2\Core\Event::class,
        \Forminator\Stripe\V2\Core\EventDestination::OBJECT_NAME => \Forminator\Stripe\V2\Core\EventDestination::class,
    ];
}
