 ...
 */
class V2CoreAccountIncludingConfigurationRecipientCapabilityStatusUpdatedEvent extends \Forminator\Stripe\V2\Core\Event
{
    ...
    public static function constructFrom($values, $opts = null, $apiMode = 'v2')
    {
        ...
        if (null !== $evt->data) {
            $evt->data = \Forminator\Stripe\EventData\V2CoreAccountIncludingConfigurationRecipientCapabilityStatusUpdatedEventData::constructFrom($evt->data, $opts, $apiMode);
        }
        return $evt;
    }
}
