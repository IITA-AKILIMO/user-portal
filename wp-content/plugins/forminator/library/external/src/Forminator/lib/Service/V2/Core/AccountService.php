...
{
    use \Forminator\Stripe\Service\ServiceNavigatorTrait;
    protected static $classMap = ['persons' => Accounts\PersonService::class, 'personTokens' => Accounts\PersonTokenService::class];
    /**
